...
Download the [besu-mainnet zip file](/files/besu/besu-mainnet.zip), which contains the genesis file, docker compose file, and the config-snap-mainnet file.
...
Download the [besu-goerli zip file](/files/besu/besu-goerli.zip), which contains the genesis file, docker compose file, and the config-snap-goerli file.
